...
class Penman_Author_Widget extends WP_Widget{
     public function __construct(){
          parent::__construct(
               'author-widget',
               __( 'Author Widget', 'penman' ),
     ...
     public function form($instance ){
          ?>
             ...
             <p>
                 <label for="<?php echo $this->get_field_id('description'); ?>"><?php _e( 'Description', 'penman' ); ?></label><br />
...
add_action( 'widgets_init', 'penman_author_widget' ); 
function penman_author_widget(){     
    register_widget( 'Penman_Author_Widget' );
