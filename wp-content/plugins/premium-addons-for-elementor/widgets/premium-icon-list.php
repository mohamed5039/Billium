	...
	protected function render() {
		...
		if ( $settings['list'] ) {
			...
			<li <?php echo $this->get_render_attribute_string( $list_content_key ); ?>>
                ...
                <div <?php echo $this->get_render_attribute_string( 'wrapper' ); ?>>
                    ...
                    if ( 'icon' === $item['icon_type'] ) {
                        ...
                        <div class="premium-icon-list-icon-text">
                            <p <?php echo $this->get_render_attribute_string( $textIcon ); ?>>
                                <?php echo $item['list_text_icon']; ?>
                            </p>
                        </div>
                ...
                <?php echo '<span ' . $this->get_render_attribute_string( 'title' ) . '  data-text="' . strip_tags( $item['list_title'] ) . '"> ' . $item['list_title'] . ' </span>'; ?>

				</div>

				<?php if ( 'yes' === $item['show_badge'] ) { ?>
                    <div class="premium-icon-list-badge">
                        <span <?php echo $this->get_render_attribute_string( $textBadge ); ?>>
                            <?php echo $item['badge_title']; ?>
                        </span>
                    </div>
                <?php } ?>
