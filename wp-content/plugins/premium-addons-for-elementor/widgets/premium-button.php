...
class Premium_Button extends Widget_Base {
	...
	protected function _register_controls() {
		...
		if ( $this->check_rtl() ) {
			$this->add_responsive_control(
				'premium_button_icon_rtl_before_spacing',
				array(
					'label'     => __( 'Icon Spacing', 'premium-addons-for-elementor' ),
					'type'      => Controls_Manager::SLIDER,
					'condition' => array(
			...
			$this->add_responsive_control(
				'premium_button_icon_rtl_after_spacing',
				array(
					'label'     => __( 'Icon Spacing', 'premium-addons-for-elementor' ),
					'type'      => Controls_Manager::SLIDER,
					'condition' => array(
		...
		<a <?php echo wp_kses_post( $this->get_render_attribute_string( 'button' ) ); ?>>
			<div class="premium-button-text-icon-wrapper">
				<?php if ( 'yes' === $settings['premium_button_icon_switcher'] ) : ?>
					...
					<?php endif; ?>
				<?php endif; ?>
				<span <?php echo wp_kses_post( $this->get_render_attribute_string( 'premium_button_text' ) ); ?>><?php echo wp_kses_post( $button_text ); ?></span>
				<?php if ( 'yes' === $settings['premium_button_icon_switcher'] ) : ?>
